    ...
    <div className="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div className="grid grid-cols-2 md:col-span-3 lg:grid-cols-6 gap-y-16 gap-x-12">
            ...
            <div>
                ...
                <li>
                    <a href="/projects" className="flex text-base text-white transition-all duration-200 hover:text-GoldenYellow focus:text-GoldenYellow">Proyek</a>
                </li>
                <li>
                    <a href="/profile" className="flex text-base text-white transition-all duration-200 hover:text-GoldenYellow focus:text-GoldenYellow">Profil</a>
                </li>
                <li>
                    <a href="/upload/project" className="flex text-base text-white transition-all duration-200 hover:text-GoldenYellow focus:text-GoldenYellow">Tambah Proyek</a>
                </li>
                </ul>
            </div>
