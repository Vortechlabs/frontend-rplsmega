    ...
    <div className="space-y-6">
      <div className="border-2 border-dashed border-gray-300 rounded-xl p-6 text-center transition-all hover:border-OxfordBlue">
        <div className="flex flex-col items-center justify-center">
          ...
          <h3 className="mt-2 text-sm font-medium text-gray-900">Unggah pratinjau karya</h3>
      ...
      {images.length > 0 ? (
            ...
            <div key={index} className="border rounded-xl p-3 hover:shadow-md transition-all relative group">
              <div className="relative h-40 w-full overflow-hidden rounded-lg">
                ...
                <button
                  ...
                  className="absolute top-2 right-2 bg-red-500 text-white rounded-full w-7 h-7 flex items-center justify-center opacity-40 group-hover:opacity-100 transition-opacity shadow-md"
                >
              ...
              <input
                ...
                placeholder="Ex: Frontend Preview"
        ...
        <div className="flex justify-center items-center h-40 border-2 border-dashed rounded-xl bg-gray-50">
          <p className="text-gray-500">Tidak ada pratinjau yang diunggah</p>
        </div>
      )}
    </div>
  );
